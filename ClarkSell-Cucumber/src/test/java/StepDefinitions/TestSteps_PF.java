...
public class TestSteps_PF {
	...
	public void user_enters_username_and_password(String username, String password) {
		// USED POM for this part : LoginPage_PF class Created
	...
	public void user_clicks_on_angebote_button()  {
		// USED POM for this part : AngebotePage_PF class Created
	...
	public void user_answers_the_questions() throws InterruptedException {
		// USED POM for this part : WeiterQuestionsPage_PF class Created
	...
	public void verify_the_correct_contract_is_shown_on_the_manager_route() {
		...
		WebElement contract=driver.findElement(By.className("_title_niboal"));
		String actualText = contract.getText();
		String expectedText = "Privathaftpflicht";
